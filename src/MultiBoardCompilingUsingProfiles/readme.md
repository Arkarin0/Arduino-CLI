# Targeting multiple Boards using Profiles

This section explains how we can compile a Sketch for multiple board using the Arduino IDE profiles.

We will configure an example profile file and compile the Sketch for the `Arduino Mega`, `Teensy 3.6`  and `Teensy 4.1`.

References:

+ [sketch specifications](https://github.com/arduino/arduino-cli/blob/master/docs/sketch-specification.md#sketch-project-file)
+ [sketch profile](https://github.com/arduino/arduino-cli/blob/master/docs/sketch-project-file.md)

Advantages using Profiles are:

+ the build is isolated from the system and will rely only on the resources specified in the profile.
+ the build is portable and reproducible
+ independently from the platforms and libraries installed in the system.

## Build profiles

>The following text was taken from the official arduino [homepage](https://github.com/arduino/arduino-cli/blob/master/docs/sketch-project-file.md).
...
`--profile` flags to the [`arduino-cli compile`](https://github.com/arduino/arduino-cli/blob/master/docs/commands/arduino-cli_compile.md),
[`arduino-cli upload`](https://github.com/arduino/arduino-cli/blob/master/docs/commands/arduino-cli_upload.md) or [`arduino-cli debug`](https://github.com/arduino/arduino-cli/blob/master/docs/commands/arduino-cli_debug.md) commands
